...
exports.checkoutSession = asyncHandler(async (req, res, next) => {
  ...
  // 3) Create stripe checkout session the way you want to pay with stripe
  const session = await stripe.checkout.sessions.create({
    ...
    mode: 'payment',
    success_url: `${req.protocol}://${req.get('host')}/orders`,// success_url: `${req.protocol}==https -://${req.get('host')}/orders`,
